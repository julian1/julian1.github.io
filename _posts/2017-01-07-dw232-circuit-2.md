...
Conditions involve an open room, exposed breadboard, high-ambient temperatures over 30C, and circulating air currents. Additionally the circuit uses only two precision resistors - the resistors for the op-amps are inexpensive 1/4watt and not tempco rated.
